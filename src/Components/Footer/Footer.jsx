                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className='flex justify-center mt-6'>
                        <form onSubmit={handleSubmit} className="w-full max-w-sm">
                            <label htmlFor="email" className="block text-white mb-2">Subscribe to our newsletter:</label>
                            <div className="flex">
                                <input
                                    type="email"
                                    id="email"
                                    ...
                                    className="flex-grow bg-gray-800 text-white border border-gray-700 rounded-l px-4 py-2 focus:outline-none"
                                />
